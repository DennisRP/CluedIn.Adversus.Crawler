...
{
    public class Adversus_Command_MeshProcessor : BaseMeshProcessor
    {
        public Adversus_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AdversusConstants.ProviderId;

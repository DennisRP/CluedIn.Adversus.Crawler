...
{
    public class DataIngestion : IClassFixture<AdversusTestFixture>
    {
        private readonly AdversusTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(AdversusTestFixture fixture, ITestOutputHelper output)
        {
